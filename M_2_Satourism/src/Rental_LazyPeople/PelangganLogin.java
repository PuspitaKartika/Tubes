...
public class PelangganLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnlihat.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                "/background/png-transparent-computer-icons-button-encapsulated-postscript-viewing-text-logo-black.png"))); // NOI18N
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnloginActionPerformed
        ...
        // usn_pelanggan = '" + u.usn_pelanggan + "' AND pw_pelanggan = '" +
        // u.pw_pelanggan + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PelangganLogin.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);

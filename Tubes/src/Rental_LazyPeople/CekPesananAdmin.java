...
public class CekPesananAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnkonfirmasi.setBounds(820, 260, 120, 40);

        btnbatalkan.setBorderPainted(false);
        btnbatalkan.setContentAreaFilled(false);
        getContentPane().add(btnbatalkan);
        btnbatalkan.setBounds(710, 260, 100, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/Konfirmasi Pesanan.png"))); // NOI18N
